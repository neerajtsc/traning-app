        ...
        <div className="flex justify-center">
          <div className="flex gap-4 mt-4 w-11/12 justify-between">
            <div className="ourWorkingTech">
              <div className=" flex justify-center items-center p-5 rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg transform scale-100 hover:scale-110 ">
              ...
              <div className=" flex mt-4 justify-center items-center  p-5 rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg transform scale-100 hover:scale-110 ">
            ...
            <div className="ourWorkingTech">
              ...
              <div className=" mt-4 flex justify-center items-centerp-5 rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg transform scale-100 hover:scale-110 ">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
